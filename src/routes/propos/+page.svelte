		...
		{#each bentoItems.filter(i => i.row === 'top') as item, i (item.id)}
			...
			>
				<div class="card-content" class:hide-content={hoveredCard === item.id}>
					...
					{#if item.id === 2}
						<p class="card-title inverted-title">{item.title}</p>
						<h3 class="card-subtitle inverted-subtitle">{item.subtitle}</h3>
					{:else}
...
<style lang="scss">
	...
	.card-2 {
		background: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.3)), url('/can_product.png') center/cover no-repeat;
	}

	.card-3 { background: linear-gradient(135deg, #d4d4d4 0%, #a3a3a3 100%); }
	.card-4 { background: linear-gradient(135deg, #e5e5e5 0%, #d4d4d4 100%); }
	.card-5 { background: linear-gradient(135deg, #d4d4d4 0%, #a3a3a3 100%); }
	...
	:global(.dark) .card-4 { background: linear-gradient(135deg, #404040 0%, #525252 100%); }
	:global(.dark) .card-5 { background: linear-gradient(135deg, #525252 0%, #737373 100%); }
	...
	@media (max-width: 1024px) {
		...
		.inverted-subtitle { font-size: 1.6rem; }
		.inverted-title { font-size: 1.05rem; }
	...
	@media (max-width: 768px) {
		...
		.inverted-subtitle { font-size: 1.5rem; }
		.inverted-title { font-size: 1rem; }
	...
	@media (max-width: 480px) {
		...
		.inverted-subtitle { font-size: 1.35rem; }
		.inverted-title { font-size: 0.95rem; }
