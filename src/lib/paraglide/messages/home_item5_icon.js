...
const de_home_item5_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};

const it_home_item5_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};
...
export const home_item5_icon = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_home_item5_icon(inputs)
	if (locale === "de") return de_home_item5_icon(inputs)
	return it_home_item5_icon(inputs)
};