...
const de_contact_item4_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};

const it_contact_item4_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};
...
export const contact_item4_icon = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_contact_item4_icon(inputs)
	if (locale === "de") return de_contact_item4_icon(inputs)
	return it_contact_item4_icon(inputs)
};