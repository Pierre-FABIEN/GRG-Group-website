...
const de_products_item4_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};

const it_products_item4_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};
...
export const products_item4_icon = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_products_item4_icon(inputs)
	if (locale === "de") return de_products_item4_icon(inputs)
	return it_products_item4_icon(inputs)
};