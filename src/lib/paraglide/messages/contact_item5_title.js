...
const de_contact_item5_title = /** @type {(inputs: {}) => string} */ () => {
	return `E-Mail-Kontakt`
};

const it_contact_item5_title = /** @type {(inputs: {}) => string} */ () => {
...
export const contact_item5_title = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_contact_item5_title(inputs)
	if (locale === "de") return de_contact_item5_title(inputs)
	return it_contact_item5_title(inputs)
};