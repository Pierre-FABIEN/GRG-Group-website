...
const en_services_item4_hovertext1 = /** @type {(inputs: {}) => string} */ () => {
	return `Thanks to our industrial network distributed across several European sites, we ensure production continuity and high logistical availability.`
};

const es_services_item4_hovertext1 = /** @type {(inputs: {}) => string} */ () => {
	return `Gracias a nuestra red industrial distribuida en varios sitios europeos, aseguramos continuidad de producción y alta disponibilidad logística.`
};
...
const services_item4_hovertext1 = (inputs = {}, options = {}) => {
	...
	return fr_services_item4_hovertext1(inputs)
};
