...
const de_services_item3_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Europäische Normen`
};

const it_services_item3_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Norme Europee`
};
...
export const services_item3_subtitle = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_services_item3_subtitle(inputs)
	if (locale === "de") return de_services_item3_subtitle(inputs)
	return it_services_item3_subtitle(inputs)
};