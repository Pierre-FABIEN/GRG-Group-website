...
const de_contact_item2_hovertext1 = /** @type {(inputs: {}) => string} */ () => {
	return `Begleiten Sie uns auf <a href="https://www.facebook.com/GRFBSmilkteasupplies/" target="_blank" rel="noopener noreferrer" class="hover-link">Facebook</a>, um unsere Neuigkeiten zu entdecken.`
};

const it_contact_item2_hovertext1 = /** @type {(inputs: {}) => string} */ () => {
	return `Unisciti a noi su <a href="https://www.facebook.com/GRFBSmilkteasupplies/" target="_blank" rel="noopener noreferrer" class="hover-link">Facebook</a> per scoprire le nostre novità.`
};
...
const contact_item2_hovertext1 = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_contact_item2_hovertext1(inputs)
	if (locale === "de") return de_contact_item2_hovertext1(inputs)
	return it_contact_item2_hovertext1(inputs)
};
