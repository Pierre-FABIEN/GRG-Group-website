...
const de_contact_item4_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Referenzen & Rückmeldungen`
};

const it_contact_item4_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Testimonianze & feedback`
};
...
export const contact_item4_subtitle = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_contact_item4_subtitle(inputs)
	if (locale === "de") return de_contact_item4_subtitle(inputs)
	return it_contact_item4_subtitle(inputs)
};