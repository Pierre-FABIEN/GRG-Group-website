...
const de_home_item2_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Schöpfung & Qualität`
};

const it_home_item2_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Creazione & Qualità`
};
...
export const home_item2_subtitle = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_home_item2_subtitle(inputs)
	if (locale === "de") return de_home_item2_subtitle(inputs)
	return it_home_item2_subtitle(inputs)
};