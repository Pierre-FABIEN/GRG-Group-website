...
const en_about_item5_title = /** @type {(inputs: {}) => string} */ () => {
	return `Your Partner`
};
...
*/
/* @__NO_SIDE_EFFECTS__ */
export const about_item5_title = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
		return /** @type {any} */ (globalThis).__paraglide_ssr.about_item5_title(inputs) 
	}
