...
const de_about_item5_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};

const it_about_item5_icon = /** @type {(inputs: {}) => string} */ () => {
	return ``
};
...
export const about_item5_icon = (inputs = {}, options = {}) => {
	...
	if (locale === "fr") return fr_about_item5_icon(inputs)
	if (locale === "de") return de_about_item5_icon(inputs)
	return it_about_item5_icon(inputs)
};